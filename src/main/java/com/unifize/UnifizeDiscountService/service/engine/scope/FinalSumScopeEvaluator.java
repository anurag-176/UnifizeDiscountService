...
public class FinalSumScopeEvaluator implements ScopeEvaluator {
    ...
    public boolean isDiscountApplicable(
        ...
        try {
            ...
            Map<String, Object> context = objectMapper.convertValue(discountedPrice, new TypeReference<>() {});
            return ConditionNodeEvaluator.evaluate(conditionNode, context);

        } catch (Exception e) {
            throw new DiscountValidationException("FINAL_SUM condition evaluation failed: " + e.getMessage());
        }
    }
    ...
    public DiscountedPrice evaluate(
        ...
        try {
            ...
            throw new DiscountCalculationException("FINAL_SUM discount evaluation failed: " + e.getMessage());
        }
    }
